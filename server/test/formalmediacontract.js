...
describe("Formal Media Contract", function() {
  let Twitter;
  let twitter;
  let owner;
  ...
  beforeEach(async function() {
    Twitter = await ethers.getContractFactory("FormalMediaContract");
  ...
  describe("Add Tweet", function() {
    it("should emit AddTweet event", async function() {
      ...
      await expect(await twitter.addTweet(tweet.tweetText, tweet.isDeleted,tweet.data)
